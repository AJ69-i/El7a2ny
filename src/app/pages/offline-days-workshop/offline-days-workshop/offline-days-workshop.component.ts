...
@Component({
  selector: 'app-offline-days-workshop',
  templateUrl: './offline-days-workshop.component.html',
  styleUrls: ['./offline-days-workshop.component.scss']
})
export class OfflineDaysWorkshopComponent implements OnInit {
  CalenderDate!:any;
  dates:any[] = [];
  GetDates:any[] = [];
  DATES:any[] = [];
